// src/components/about/HistoryContent.tsx
      ...
      <div className="container mx-auto max-w-4xl px-6 py-16 md:py-24">
        <div className="prose prose-lg dark:prose-invert max-w-none text-neutral-700">
          ...
          <p>
            ...
            satu langkah strategis yang dilakukan adalah mengubah fungsi lembaga
            bimbingan belajar menjadi{" "}
          ...
          <p>
            ...
            naungan <strong>Yayasan Al Madeena Cendekia Muslim</strong>. Lembaga
            ini memulai kiprahnya dengan membuka jenjang{" "}
            <strong>Preschool</strong> bagi anak usia <strong>3–5 tahun</strong>
            , dengan program unggulan yang memadukan{" "}
            <strong>Qiroati, Tahfiz, Bahasa Inggris (Bilingual),</strong> dan{" "}
            <strong>Islamic Character</strong>.
          </p>
          <p>
          ...
          <p>
            ...
            <strong>Juli 2023</strong>, Yayasan Al Madeena Cendekia Muslim resmi
            membuka jenjang pendidikan berikutnya, yaitu{" "}
            ...
            <strong>muatan kurikulum madrasah</strong>, sebagai bentuk integrasi
            antara pendidikan umum, agama, dan internasional.
          </p>
          <p>

        ...
        {selectedStaff && selectedStaffData && (
          ...
          >
            ...
            >
              ...
              <button
                onClick={handleCloseModal}
                className="absolute top-4 right-4 z-50 rounded-full bg-white/80 p-2 text-gray-900 hover:bg-white transition-colors"
              >
                <svg
                  className="h-6 w-6"
                  fill="none"
              ...
              <div className="flex flex-col md:flex-row h-full">
                ...
                <div className="flex flex-1 flex-col p-8 md:p-10 overflow-y-auto">
                  <div className="mb-6">
                    ...
                    <p className="mt-2 text-gray-500">{selectedStaffData.pronouns}</p>
                  </div>

                  <blockquote className="border-l-4 border-[#0094D9] pl-4 italic text-gray-700 text-lg mb-8">
                    "{selectedStaffData.quote}"
                  </blockquote>

                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 text-sm text-gray-600">
                    <div>
                        <h4 className="font-bold text-gray-900 mb-1">Jabatan</h4>
                        <p>{selectedStaffData.role}</p>
                    </div>
                     <div>
                        <h4 className="font-bold text-gray-900 mb-1">ID Yayasan</h4>

...
import { newsItemsData, type NewsItem } from "~/data/newsData";
    ...
    <div className="flex flex-col overflow-hidden bg-white shadow-md transition-shadow duration-300 hover:shadow-lg">
      ...
      <div className="flex grow flex-col bg-[#0094D9] p-5 text-white md:p-6">
        ...
        <Link
          href={item.linkUrl}
          className={cn(
            "mt-auto self-start rounded bg-[#FFD500] px-4 py-2 text-sm font-semibold text-[#0062b9] transition-colors duration-200 hover:bg-yellow-400 focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 focus:ring-offset-[#0094D9] focus:outline-none",
          )}
        >
          Selengkapnya
        </Link>

...
export default function Quote() {
  return (
    <section className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-[#ffffff] px-6 py-20 text-center md:py-0">
      ...
      <div className="relative z-10 max-w-3xl px-4">
        <p className="text-base leading-relaxed font-medium text-black sm:text-xl md:text-2xl">
